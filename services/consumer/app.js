...
// const kafkaClient = new kafka.KafkaClient(process.env.KAFKA_ZOOKEEPER_CONNECT, 'consumer-client', kafkaClientOptions);
...
kafkaClient.on('ready', err => console.log(err));
